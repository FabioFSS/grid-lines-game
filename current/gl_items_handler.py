...
class GLItemHandler():
    ...
    def __rotate_item(self, item, direction) -> list:
        ...
        Parameters:
            -item (tuple): the item you want to rotate.
            -direction (string): the direction that the item will be rotated in.

        Returns:
            -final (tuple): the rotated item.
        '''
        ...
        final = tuple([tuple(line) for line in transposed])

        return final


    def select_item(self, number) -> tuple:
        '''
        ...
        Returns:
            -current_item (tuple): the selected item.
        '''
    ...
    def get_current_item(self) -> tuple:
        ...
        Returns:
            -current_item (tuple): the currently selected item.
        '''
